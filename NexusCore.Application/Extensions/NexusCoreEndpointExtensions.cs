...
namespace NexusCore.Application.Extensions;

public static class NexusCoreEndpointExtensions
{
    public static IEndpointRouteBuilder MapNexusCoreAuthEndpoints(this IEndpointRouteBuilder app)
    {
    ...
    public static IEndpointRouteBuilder MapNexusCoreManagementEndpoints(this IEndpointRouteBuilder app)
    {
    ...
    public static IEndpointRouteBuilder MapNexusCorePlatformEndpoints(this IEndpointRouteBuilder app)
    {
